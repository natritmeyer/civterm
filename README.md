...
- [![Last commit](https://img.shields.io/github/last-commit/natritmeyer/civterm)](<>) [![Build status](https://img.shields.io/github/actions/workflow/status/natritmeyer/civterm/ci.yml?label=build)](https://github.com/natritmeyer/civterm/actions) [![Tests](https://img.shields.io/badge/tests-401%20passing-brightgreen)](<>)
